...
void Print(const int screenWidth, const int a, const int b, const unsigned int FontSize, const char* str);
void PutCharacter(unsigned int chr, const int a, const int b, const unsigned int FontSize);

int main()
{
    Print(SCREENWIDTH, 1, 1, 3, "Hi");
    return 0;
}
