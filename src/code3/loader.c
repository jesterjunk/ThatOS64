...
void tmain(BLOCKINFO* bi)
{
	...
	Print(bi, bi->ScreenWidth, 1, 1, 3, BADCYAN, "We");
...
9490608,2415924244,337379332,67372800, // 008  --  Backspace                    SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 009  --  Horizontal Tab               SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 010  --  New Line ( Line Feed )   \n  SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 011  --  Vertical Tab                 SET TO NULL FOR NOW

9490608,2415924244,337379332,67372800, // 012  --  Form Feed                    SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 013  --  Carriage Return \r           SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 014  --  Shift Out                    SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 015  --  Shift In                     SET TO NULL FOR NOW
};

unsigned int asciifont2[64] = {
9490608,2415924244,337379332,67372800, // 016  --  Data Link Escape          SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 017  --  Device Control 1          SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 017  --  Device Control 2          SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 017  --  Device Control 3          SET TO NULL FOR NOW

9490608,2415924244,337379332,67372800, // 017  --  Device Control 4          SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 021  --  Negative Ack              SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 022  --  Synchronous Idle          SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 023  --  End Transmission Block    SET TO NULL FOR NOW

9490608,2415924244,337379332,67372800, // 024  --  Cancel                    SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 025  --  End of Medium             SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 026  --  Substitute                SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 027  --  Escape ( ESC / FSC )      SET TO NULL FOR NOW

9490608,2415924244,337379332,67372800, // 028  --  File Separator            SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 029  --  Group Separator           SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 030  --  Record Separator          SET TO NULL FOR NOW
9490608,2415924244,337379332,67372800, // 031  --  Unit Separator            SET TO NULL FOR NOW
};
